...
const Experience = () => {
  const skills = {
    ...
    lib: [
      ...
      { id: 1, name: 'React Native', progress: 85 },
      { id: 1, name: 'Redux', progress: 100 },
      { id: 2, name: 'NextJS', progress: 100 },
      { id: 3, name: 'Framework7', progress: 100 },
      { id: 4, name: 'NodeJS', progress: 80 },
      { id: 5, name: 'VUE', progress: 60 },
      { id: 6, name: 'Stripe', progress: 90 },
      { id: 7, name: 'Vonage', progress: 100 },
    ],
    tech: [
      { id: 1, name: 'AI agents', progress: 100 },
      { id: 2, name: 'GIT', progress: 100 },
      { id: 3, name: 'Cloudflare', progress: 100 },
      { id: 4, name: 'AWS', progress: 30 },
      { id: 5, name: 'Linux / Unix', progress: 80 },
      { id: 6, name: 'Mac', progress: 100 },
      { id: 7, name: 'WebSocket', progress: 100 },
      { id: 8, name: 'WebRTC', progress: 100 },
      { id: 9, name: 'SIP', progress: 100 },
      { id: 10, name: 'REST', progress: 100 },
      { id: 11, name: 'NoSQL', progress: 75 },
      { id: 12, name: 'MySQL', progress: 60 },
      { id: 13, name: 'Serwerless', progress: 80 },
      { id: 14, name: 'HLS', progress: 100 },
      { id: 15, name: 'Blackmagic API', progress: 100 },
      { id: 15, name: 'FFmpeg, streaming', progress: 100 },
    ],
  };
  return (
